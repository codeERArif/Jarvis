...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('arf4852@gmail.com', 'mail#2584')
    ...
    while True:
        ...
        if 'wikipedia' in query:
          ...
          if 'yes'in reply:
            ...
            yourname= "Jarvis"
            speak(f"Sir, my name is {yourname}")
            
        elif 'old i am' in query:
            age = "you are twenty years old"
            speak(age)
            ...
            try:
                ...
                content=takeCommand()
                to = 'shubhamprajapati1384@gmail.com'
